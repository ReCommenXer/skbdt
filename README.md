...
function loadcheck()
    ...
    pcall(function()
        _G.SaveSettings = {Auto_Set_Speed = false, Auto_Join = false}
    end)
    function LoadSetting()
        if isfile("RebornXer Hub Skibidi Tower Defense"..game.Players.LocalPlayer.Name..".json") then
            -- โหลดไฟล์
            local fileContent = readfile("RebornXer Hub Skibidi Tower Defense"..game.Players.LocalPlayer.Name..".json")
...
function pleceUnit(NameUnit,CFrameUnit,UnitSlot)
	game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.UnitService.RF.PlaceUnit:InvokeServer(NameUnit, {Rotation = 0, Position = Vector3.new(CFrameUnit)}, UnitSlot)
	end
	
	function SetSpeed(number)
		game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.WaveService.RF.SetGameSpeed:InvokeServer(number)
	end
	
	function SellUnit(UnitNumber)
		game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.UnitService.RF.DeleteUnit:InvokeServer(UnitNumber)
	end
	
	function SkipWave()
		game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.WaveService.RF.ToggleAutoSkip:InvokeServer()
	end
	
	function SelectMode(ModeName)
		game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.GameService.RF.MapVote:InvokeServer(ModeName)
	end
	
	function JoinMap(MapName)
		game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.6.0").knit.Services.QueueService.RF.Quickplay:InvokeServer(MapName)
	end
...
Main:AddLabelLeft("Map : Anime Vanguards")
Date = os.date("%d".." ".."%B".." ".."%Y")
...
spawn(function()
	while wait() do 
		pcall(function()
			if _G.SaveSettings.Auto_Join then
				JoinMap(_G.SaveSettings.Map_Select)
			end
		end)
	end
end)
...
spawn(function()
	while wait() do 
		pcall(function()
			if _G.SaveSettings.Auto_Vote_Mode then
				SelectMode(_G.SaveSettings.Mode_Select)
			end
		end)
	end
end)
...
Main:AddDropdownLeft('Select Speed',SpeedList,_G.SaveSettings.Speed_Select,function(a)
    Speed_Select = a
    _G.SaveSettings.Speed_Select = Speed_Select
    SaveSetting()
end)
...
spawn(function()
	while wait() do 
		pcall(function()
			if _G.SaveSettings.Auto_Set_Speed then
				SetSpeed(_G.SaveSettings.Speed_Select)
				_G.SaveSettings.Auto_Set_Speed = false
			end
		end)
	end
end)
...
Main:AddToggleLeft("Auto Vote Mode",_G.SaveSettings.Auto_Vote_Mode,function(a)
    Auto_Vote_Mode = a
    _G.SaveSettings.Auto_Vote_Mode = Auto_Vote_Mode
    SaveSetting()
end)

Main:AddToggleLeft("Auto Set Speed",_G.SaveSettings.Auto_Set_Speed,function(a)
	Auto_Set_Speed = a
    _G.SaveSettings.Auto_Set_Speed = Auto_Set_Speed
    SaveSetting()
end)

CFrameList = {
        "-321.735992, -136.19986, -150.242065, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-320.676178, -136.339813, -160.281799, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-325.294128, -136.199814, -160.309982, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-321.428864, -136.339813, -165.238159, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-325.96228, -136.339813, -164.998062, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-320.553833, -136.339813, -145.506638, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-320.382965, -136.19989, -140.863892, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-325.172028, -136.339813, -145.168961, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-325.449158, -136.199844, -140.478394, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-312.122986, -136.199905, -151.120712, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-307.384003, -136.339813, -150.931839, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-311.911072, -136.199905, -146.426056, 1, 0, 0, 0, 1, 0, 0, 0, 1",
        "-307.422, -136.34, -146.091",
        "-336.933, -136.34, -145.036",
        "-336.287, -136.2, -149.492"
}
